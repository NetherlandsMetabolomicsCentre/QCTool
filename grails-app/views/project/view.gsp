...
<html>
    ...
    <body>
        <div style="float: right;"><g:formatDate date="${project.dateCreated}" type="datetime" style="MEDIUM"/></div>
        ...
        <div class="tab-pane active" id="mf">
            <div style="width: 450px; border: thin solid #cdcdcd; padding: 10px;">
                ...
                <g:uploadForm controller="project" action="addFiles" id="${project?.id}" name="myUpload">
                    select file: <input type="file" name="fileUpload" multiple/> <g:submitButton class="btn" name="submit" value="submit"/>
                </g:uploadForm>
            </div>
